...
public:
	...
	std::unique_ptr<VertexBuffer> initVertexBuffer() override {
		GLfloat vertices[] = {
			...
			-1.0f,	-1.0f,	 1.0f,	-1.0f,	-1.0f,	 1.0f,	1.0f,	0.75f, //0
			 1.0f,	-1.0f,	 1.0f,	 1.0f,	-1.0f,	 1.0f,	0.25f,	0.75f, //1
			 1.0f,	 1.0f,	 1.0f,	 1.0f,	 1.0f,	 1.0f,	0.5f,	0.75f, //2
			-1.0f,	 1.0f,	 1.0f,	-1.0f,	 1.0f,	 1.0f,	0.75f,	0.75f, //3
			-1.0f,	-1.0f,	-1.0f,  -1.0f,	-1.0f,	-1.0f,	1.0f,	0.25f, //4
			 1.0f,	-1.0f,	-1.0f,	 1.0f,	-1.0f,	-1.0f,	0.25f,	0.25f, //5
			 1.0f,	 1.0f,	-1.0f,	 1.0f,	 1.0f,	-1.0f,	0.5f,	0.25f, //6
			-1.0f,	 1.0f,	-1.0f,	-1.0f,	 1.0f,	-1.0f,	0.75f,	0.25f, //7
