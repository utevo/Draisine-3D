...
public:
	...
	std::unique_ptr<VertexBuffer> initVertexBuffer() override {
		GLfloat vertices[] = {
			...
			-1.0f,	-1.0f,	 1.0f,	-1.0f,	-1.0f,	 1.0f,	1.0f,	2.0f/3, //0
			 1.0f,	-1.0f,	 1.0f,	 1.0f,	-1.0f,	 1.0f,	0.25f,	2.0f/3, //1
			 1.0f,	 1.0f,	 1.0f,	 1.0f,	 1.0f,	 1.0f,	0.5f,	2.0f/3, //2
			-1.0f,	 1.0f,	 1.0f,	-1.0f,	 1.0f,	 1.0f,	0.75f,	2.0f/3, //3
			-1.0f,	-1.0f,	-1.0f,  -1.0f,	-1.0f,	-1.0f,	1.0f,	1.0f/3, //4
			 1.0f,	-1.0f,	-1.0f,	 1.0f,	-1.0f,	-1.0f,	0.25f,	1.0f/3, //5
			 1.0f,	 1.0f,	-1.0f,	 1.0f,	 1.0f,	-1.0f,	0.5f,	1.0f/3, //6
			-1.0f,	 1.0f,	-1.0f,	-1.0f,	 1.0f,	-1.0f,	0.75f,	1.0f/3, //7
